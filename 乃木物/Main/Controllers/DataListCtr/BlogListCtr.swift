...
class BlogListCtr: BaseCtr {

    //数据源
    private var dataSource:TableViewTwoCellDataSource<BlogListCtr>!
    ...
    fileprivate func getDataListInfo(isFoot:Bool=false){
        ...
        if !isFoot {
            HttpClient_Alamofire.blogList(params: dic, success: { (dataObjc) in
...
extension BlogListCtr:TableViewDataTwoCellSourceDelegate{
...
extension BlogListCtr:UITableViewDelegate {
